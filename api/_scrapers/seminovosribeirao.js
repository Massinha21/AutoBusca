// api/parsers/seminovosribeirao.js
// Seminovos Ribeirão Veículos — GET /veiculos?modelo=<query>
// Plataforma AutoCerto — compartilha a mesma estrutura de plataforma da Auto Mais Veículos

const cheerio = require("cheerio");
const NAME     = "Seminovos Ribeirão Veículos";
const BASE_URL = "http://www.seminovosribeiraoveiculos.com.br";
